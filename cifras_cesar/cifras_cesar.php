...
<head>
    ...
    <title>Cifras de César</title>
</head>
<body style="background-color: #CDF2FF">
    <br>
    <form method="post">
        <div class="d-flex justify-content-center">
            <div class="w-50 p-3">
                ...
                <div class="card container">
                    <div class="container">
                        <h3 class="text-center">Cifras de César</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control col-sm-2" name="chave" min="0" max="9" required><br/>
                            </div>
                        </div>
